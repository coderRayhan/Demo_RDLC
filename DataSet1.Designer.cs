...
namespace Demo_RDLC {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, bool IsRegular, System.DateTime DoB) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public bool IsRegular {
                get {
                    return ((bool)(this[this.tableStudents.IsRegularColumn]));
                }
                set {
                    this[this.tableStudents.IsRegularColumn] = value;
                }
            }
...
namespace Demo_RDLC.DataSet1TableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([Id] = @Original_Id) AND ([IsRegular] = @Ori" +
                "ginal_IsRegular) AND ([DoB] = @Original_DoB))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [IsRegular], [DoB]) VALUES (@Name, @IsRegul" +
                "ar, @DoB);\r\nSELECT Id, Name, IsRegular, DoB FROM Students WHERE (Id = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [Name] = @Name, [IsRegular] = @IsRegular, [DoB] = @Do" +
                "B WHERE (([Id] = @Original_Id) AND ([IsRegular] = @Original_IsRegular) AND ([DoB" +
                "] = @Original_DoB));\r\nSELECT Id, Name, IsRegular, DoB FROM Students WHERE (Id = " +
                "@Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Demo_RDLC.Properties.Settings.Default.StudentDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, IsRegular, DoB FROM dbo.Students";
        ...
        public virtual int Delete(int Original_Id, bool Original_IsRegular, System.DateTime Original_DoB) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((bool)(Original_IsRegular));
        ...
        public virtual int Insert(string Name, bool IsRegular, System.DateTime DoB) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((bool)(IsRegular));
        ...
        public virtual int Update(string Name, bool IsRegular, System.DateTime DoB, int Original_Id, bool Original_IsRegular, System.DateTime Original_DoB, int Id) {
            if ((Name == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((bool)(IsRegular));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((System.DateTime)(DoB));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_Id));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((bool)(Original_IsRegular));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, bool IsRegular, System.DateTime DoB, int Original_Id, bool Original_IsRegular, System.DateTime Original_DoB) {
            return this.Update(Name, IsRegular, DoB, Original_Id, Original_IsRegular, Original_DoB, Original_Id);
        }
    }
